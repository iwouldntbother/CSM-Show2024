...
struct qt_meta_stringdata_CLASSDisplayWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDisplayWidgetENDCLASS = QtMocHelpers::stringData(
    "DisplayWidget",
    "updateFrame",
    "",
    "showSvg",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDisplayWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DisplayWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDisplayWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDisplayWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDisplayWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void DisplayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showSvg((*reinterpret_cast< std::add_pointer_t<std::string>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *DisplayWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDisplayWidgetENDCLASS.stringdata0))
